              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-slate-900">Weekly Active Users</p>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-slate-900">Certificates Earned</p>
                      <p className="text-2xl font-bold text-slate-900">89</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-sm text-green-600 font-medium">+34%</p>
                    <p className="text-xs text-slate-500">vs last month</p>
                  </div>
                </div>
              </div>
          ...
          <div className="p-6 border-b border-slate-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-slate-900">AI Module Builder</h2>
                  <p className="text-sm text-slate-600">Create intelligent learning modules with AI assistance</p>
                </div>
              </div>
              <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-lg hover:shadow-lg transition-all duration-200 flex items-center space-x-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-blue-600 rounded-xl p-6 text-white">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-semibold">Invite Employees</h3>
            </div>
            <p className="text-blue-100 mb-4">Add new team members to your learning platform</p>
          ...
          <div className="bg-purple-600 rounded-xl p-6 text-white">
            ...
            <p className="text-purple-100 mb-4">Detailed analytics and progress reports</p>
          ...
          <div className="bg-green-600 rounded-xl p-6 text-white">
            ...
            <p className="text-green-100 mb-4">Configure your learning environment</p>
