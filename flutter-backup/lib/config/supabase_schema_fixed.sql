-- 🚀 TUTORA PRODUCTION DATABASE SCHEMA (FIXED)
...
-- Companies policies (super admin can access all)
...
-- Users policies (company isolation)
...
-- Modules policies (company isolation)
...
-- Analytics policies (company isolation)
...
-- Support tickets policies (company isolation)
