-- 🚀 TUTORA STEP BY STEP FIX
-- This script fixes the enum issue step by step
...
-- ========================================
-- STEP 1: CONVERT ROLE COLUMN TO TEXT FIRST
-- ========================================

-- First, convert the role column to text so we can update the values
...
-- Now convert the text column back to the new enum
...
-- ========================================
-- STEP 8: DROP EXISTING TRIGGERS FIRST
-- ========================================
...
-- ========================================
-- STEP 11: DROP EXISTING POLICIES
-- ========================================
