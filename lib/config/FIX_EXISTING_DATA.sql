-- 🚀 TUTORA FIX EXISTING DATA
-- This script handles existing data with "superadmin" and updates it properly
...
-- Update existing "superadmin" to "super_admin" in the users table
UPDATE users SET role = 'super_admin' WHERE role = 'superadmin';

-- Update any other role mismatches
UPDATE users SET role = 'admin' WHERE role = 'administrator';
UPDATE users SET role = 'manager' WHERE role = 'management';

-- ========================================
-- STEP 2: COMPLETELY RESET USER_ROLE ENUM
-- ========================================
...
-- ========================================
-- STEP 7: DROP EXISTING TRIGGERS FIRST
-- ========================================
...
-- ========================================
-- STEP 10: DROP EXISTING POLICIES
-- ========================================
