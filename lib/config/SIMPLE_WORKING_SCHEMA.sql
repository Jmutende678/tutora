-- 🚀 TUTORA SIMPLE WORKING SCHEMA
-- This script works step by step to avoid column reference errors
...
-- ========================================
-- STEP 1: CREATE TABLES WITHOUT TRIGGERS
-- ========================================
...
-- ========================================
-- STEP 4: CREATE TRIGGERS (AFTER FUNCTIONS)
-- ========================================
