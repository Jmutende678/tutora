...
export default function AIModuleBuilder() {
          ...
          <div className="text-center">
            <button
              onClick={() => {
                ...
                console.log('Button clicked - moving to upload stage')
  ...
  if (currentStage === 'upload') {
    console.log('Rendering upload stage')
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        <div className="container mx-auto px-6 py-12">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-blue-600 mt-2">DEBUG: Upload stage is working!</p>
            </div>
