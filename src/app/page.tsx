              ...
              <div className="relative">
                <div className="aspect-[4/3] relative rounded-2xl overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-500">
                  <Image
                    ...
                    alt="Professional using mobile training app - AI-powered employee training platform"
                    fill
        ...
        <section className="py-24 bg-gradient-to-br from-gray-50 to-blue-50">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                See how organizations across industries are transforming their training with Tutora's AI-powered platform.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-8 mb-16">
              {/* Testimonial 1 - Healthcare */}
              <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300">
                ...
                <blockquote className="text-gray-700 mb-6">
                  "Tutora transformed our patient safety training. We went from 6 weeks to create a module to just 2 hours. Our compliance scores improved by 40% and staff engagement is through the roof."
                </blockquote>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Sarah Chen</div>
                    <div className="text-gray-600 text-sm">Director of Training, MedCare Health System</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300">
                ...
                <blockquote className="text-gray-700 mb-6">
                  "Our seasonal hiring used to be a nightmare. Now we onboard 50+ employees in days instead of weeks. Customer satisfaction scores increased 25% since implementing Tutora."
                </blockquote>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Marcus Rodriguez</div>
                    <div className="text-gray-600 text-sm">Regional Manager, FreshMart Grocery</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300">
                ...
                <blockquote className="text-gray-700 mb-6">
                  "The AI-generated cybersecurity modules are incredibly thorough. We've seen a 60% reduction in security incidents since rolling out company-wide training. ROI was immediate."
                </blockquote>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600 text-sm">CISO, TechFlow Solutions</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-16">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-500">vs traditional training</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600 mb-2">65%</div>
                <div className="text-gray-600">Cost Reduction</div>
                <div className="text-sm text-gray-500">in training expenses</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600 mb-2">10x</div>
                <div className="text-gray-600">Faster Creation</div>
                <div className="text-sm text-gray-500">than manual methods</div>
              </div>
              <div className="text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-2xl p-8 border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-2 text-sm text-gray-600">Manufacturing</span>
                </div>
                <blockquote className="text-gray-700 mb-4">
                  "Safety incidents dropped 45% after implementing Tutora's OSHA-compliant training modules. The AI creates scenarios specific to our equipment and processes."
                </blockquote>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600 text-sm">Safety Director, Precision Manufacturing</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 border border-gray-200">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-2 text-sm text-gray-600">Financial Services</span>
                </div>
                <blockquote className="text-gray-700 mb-4">
                  "Compliance training used to take weeks to develop. Now we create regulatory updates in hours and deploy instantly to 200+ advisors. Audit scores improved dramatically."
                </blockquote>
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-violet-600 rounded-full flex items-center justify-center text-white font-bold mr-3">
                    L
                  </div>
                  <div>
                    <div className="font-semibold text-gray-900">Lisa Thompson</div>
                    <div className="text-gray-600 text-sm">Compliance Manager, Wealth Advisors Inc</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center mt-16">
              <p className="text-lg text-gray-600 mb-6">
                Join these successful companies and transform your training today.
              </p>
